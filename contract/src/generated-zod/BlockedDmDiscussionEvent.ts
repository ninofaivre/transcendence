...
export interface CompleteBlockedDmDiscussionEventInput
	extends z.input<typeof BlockedDmDiscussionEventModel> {
	blockingUser: CompleteUserInput
	blockedUser: CompleteUserInput
	dmDiscussionEvent?: CompleteDmDiscussionEventInput | null
}

export interface CompleteBlockedDmDiscussionEventOutput
	extends z.infer<typeof BlockedDmDiscussionEventModel> {
 ...
 */
export const RelatedBlockedDmDiscussionEventModel: z.ZodSchema<
	CompleteBlockedDmDiscussionEventOutput,
	z.ZodTypeDef,
	CompleteBlockedDmDiscussionEventInput
> = z.lazy(() =>
	BlockedDmDiscussionEventModel.extend({
