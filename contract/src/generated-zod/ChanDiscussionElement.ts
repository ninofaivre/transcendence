...
export interface CompleteChanDiscussionElementInput
	extends z.input<typeof ChanDiscussionElementModel> {
...
export interface CompleteChanDiscussionElementOutput
	extends z.infer<typeof ChanDiscussionElementModel> {
 ...
 */
export const RelatedChanDiscussionElementModel: z.ZodSchema<
	CompleteChanDiscussionElementOutput,
	z.ZodTypeDef,
	CompleteChanDiscussionElementInput
> = z.lazy(() =>
	ChanDiscussionElementModel.extend({
