...
export interface CompleteChanDiscussionEventOutput
	extends z.infer<typeof ChanDiscussionEventModel> {
 ...
 */
export const RelatedChanDiscussionEventModel: z.ZodSchema<
	CompleteChanDiscussionEventOutput,
	z.ZodTypeDef,
	CompleteChanDiscussionEventInput
> = z.lazy(() =>
	ChanDiscussionEventModel.extend({
