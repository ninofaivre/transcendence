...
export interface CompleteChanDiscussionMessageInput
	extends z.input<typeof ChanDiscussionMessageModel> {
...
export interface CompleteChanDiscussionMessageOutput
	extends z.infer<typeof ChanDiscussionMessageModel> {
 ...
 */
export const RelatedChanDiscussionMessageModel: z.ZodSchema<
	CompleteChanDiscussionMessageOutput,
	z.ZodTypeDef,
	CompleteChanDiscussionMessageInput
> = z.lazy(() =>
	ChanDiscussionMessageModel.extend({
