...
export interface CompleteChanInvitationDmDiscussionEventInput
	extends z.input<typeof ChanInvitationDmDiscussionEventModel> {
	chanInvitation: CompleteChanInvitationInput
	dmDiscussionEvent?: CompleteDmDiscussionEventInput | null
}

export interface CompleteChanInvitationDmDiscussionEventOutput
	extends z.infer<typeof ChanInvitationDmDiscussionEventModel> {
 ...
 */
export const RelatedChanInvitationDmDiscussionEventModel: z.ZodSchema<
	CompleteChanInvitationDmDiscussionEventOutput,
	z.ZodTypeDef,
	CompleteChanInvitationDmDiscussionEventInput
> = z.lazy(() =>
	ChanInvitationDmDiscussionEventModel.extend({
