...
export interface CompleteClassicDmDiscussionEventInput
	extends z.input<typeof ClassicDmDiscussionEventModel> {
	dmDiscussionEvent?: CompleteDmDiscussionEventInput | null
}

export interface CompleteClassicDmDiscussionEventOutput
	extends z.infer<typeof ClassicDmDiscussionEventModel> {
 ...
 */
export const RelatedClassicDmDiscussionEventModel: z.ZodSchema<
	CompleteClassicDmDiscussionEventOutput,
	z.ZodTypeDef,
	CompleteClassicDmDiscussionEventInput
> = z.lazy(() =>
	ClassicDmDiscussionEventModel.extend({
