...
export interface CompleteDeletedMessageChanDiscussionEventInput
	extends z.input<typeof DeletedMessageChanDiscussionEventModel> {
	deletingUsers: CompleteUserInput
	chanDiscussionEvent?: CompleteChanDiscussionEventInput | null
}

export interface CompleteDeletedMessageChanDiscussionEventOutput
	extends z.infer<typeof DeletedMessageChanDiscussionEventModel> {
 ...
 */
export const RelatedDeletedMessageChanDiscussionEventModel: z.ZodSchema<
	CompleteDeletedMessageChanDiscussionEventOutput,
	z.ZodTypeDef,
	CompleteDeletedMessageChanDiscussionEventInput
> = z.lazy(() =>
	DeletedMessageChanDiscussionEventModel.extend({
