...
export interface CompleteDmDiscussionElementOutput
	extends z.infer<typeof DmDiscussionElementModel> {
 ...
 */
export const RelatedDmDiscussionElementModel: z.ZodSchema<
	CompleteDmDiscussionElementOutput,
	z.ZodTypeDef,
	CompleteDmDiscussionElementInput
> = z.lazy(() =>
	DmDiscussionElementModel.extend({
