 ...
 */
export const RelatedDmDiscussionEventModel: z.ZodSchema<
	CompleteDmDiscussionEventOutput,
	z.ZodTypeDef,
	CompleteDmDiscussionEventInput
> = z.lazy(() =>
	DmDiscussionEventModel.extend({
