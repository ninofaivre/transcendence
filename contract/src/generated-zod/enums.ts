...
export const zAccessPolicyLevel = z.enum(["NO_ONE", "ONLY_FRIEND", "IN_COMMON_CHAN", "ANYONE"])

export const zDirectMessageStatus = z.enum(["ENABLED", "DISABLED"])

export const zClassicDmEventType = z.enum(["CREATED_FRIENDSHIP", "DELETED_FRIENDSHIP"])

export const zTimedStatusType = z.enum(["MUTE", "BAN"])
