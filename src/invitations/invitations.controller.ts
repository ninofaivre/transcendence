...
// {
	...
	// @TsRest(c.getPendingFriendInvitations)
	// async getPendingFriendInvitations(@Request()req: any, @TsRestRequest(){}: RequestShapes['getPendingFriendInvitations'])
	// {
	...
	//
	// @UseGuards(JwtAuthGuard)
	// @TsRest(c.getPendingFriendInvitationsByType)
	// async getPendingFriendInvitationsByType(@Request()req: any, @TsRestRequest(){ params: { type } }: RequestShapes['getPendingFriendInvitationsByType'])
	// {
	...
	//
	// @UseGuards(JwtAuthGuard)
	// @TsRest(c.deletePendingFriendInvitationById)
	// async deletePendingFriendInvitationById(@Request()req: any, @TsRestRequest(){ params: { id, type } } :RequestShapes['deletePendingFriendInvitationById'])
	// {
	...
	//
	// @UseGuards(JwtAuthGuard)
	// @TsRest(c.getPendingChanInvitations)
	// async getPendingChanInvitations(@Request()req: any)
	// {
	...
	//
	// @UseGuards(JwtAuthGuard)
	// @TsRest(c.getPendingChanInvitationsByType)
	// async getPendingChanInvitationsByType(@Request()req: any, @TsRestRequest(){ params: { type } }: RequestShapes['getPendingChanInvitationsByType'])
	// {
	...
	//
	// @UseGuards(JwtAuthGuard)
	// @TsRest(c.deletePendingChanInvitationById)
	// async deletePendingChanInvitationById(@Request()req: any, @TsRestRequest(){ params: { id, type } }: RequestShapes['deletePendingChanInvitationById'])
	// {
