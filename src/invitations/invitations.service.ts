...
export class InvitationsService
{
	...
	// {
	// 	const arg: Prisma.FriendInvitationFindManyArgs = { where: { status: FriendInvitationStatus.PENDING }, select: this.friendInvitationSelect }
	// 	const res = await this.prisma.user.findUnique({ where: { name: username },
	// 		select:
	// 		{
	// 			incomingFriendInvitation: arg,
	// 			outcomingFriendInvitation: arg,
	// 		}})
	// 	if (!res)
	...
	// 		select:
	// 		{
	// 			incomingFriendInvitation: (filter == 'INCOMING') && arg,
	// 			outcomingFriendInvitation: (filter == 'OUTCOMING') && arg,
	// 		}})
	// 	if (!res)
	// 		throw new InternalServerErrorException(`your account has beed deleted, please logout`)
	...
	// 	if (toCheck.outcomingFriendInvitation.length)
	// 		throw new ForbiddenException(`you already invited ${invitedUsername}`)
	...
	// }
	//
	// // TODO: Update this with the new SSE
	// async deleteFriendInvitation(username: string, type: InvitationFilter, id: number)
	// {
	// 	try
	// 	{
	// 		const res = await this.prisma.friendInvitation.update({
	// 			where:
	// 			{
	// 				id: id,
	...
	// 			data:
	// 			{
	// 				status: (type === 'INCOMING') ? FriendInvitationStatus.REFUSED : FriendInvitationStatus.CANCELED
	// 			},
	// 			select:
	// 			{
	...
	// {
	// 	const arg: Prisma.ChanInvitationFindManyArgs = { where: { status: ChanInvitationStatus.PENDING }, select: this.chanInvitationsSelect }
	// 	const res = await this.prisma.user.findUnique({ where: { name: username },
	// 		select:
	// 		{
	// 			incomingChanInvitation: arg,
	// 			outcomingChanInvitation: arg,
	// 		}})
	// 	if (!res)
	// 		throw new InternalServerErrorException(`your account has been deleted, please logout`)
	...
	// 		select:
	// 		{
	// 			incomingChanInvitation: (chanInvitationType === 'INCOMING') && arg,
	// 			outcomingChanInvitation: (chanInvitationType === 'OUTCOMING') && arg,
	// 		}})
	// 	if (!res)
	// 		throw new InternalServerErrorException(`your account has been deleted, please logout`)
	...
	// 			await this.prisma.chanInvitation.update({ where:
	// 				{
	// 					id: invitationId,
	...
	// 				data:
	// 				{
	// 					status: (chanInvitationType === 'INCOMING') ? ChanInvitationStatus.REFUSED : ChanInvitationStatus.CANCELED
	// 				},
	// 				select:
	// 				{
	...
	// 			{
	// 				type: (chanInvitationType === 'INCOMING') ? EventTypeList.CHAN_INVITATION_REFUSED : EventTypeList.CHAN_INVITATION_CANCELED,
	...
	// 	catch
	// 	{
	// 		throw new NotFoundException(`pending invitation with id ${invitationId} not found`)
	// 	}
	// }
}
